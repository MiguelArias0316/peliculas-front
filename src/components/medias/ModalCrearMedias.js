...
export default function ModalCrearMedias({ handleChange, media, guardarMedia, generosActivos= [], directoresActivos= [], productorasActivos= [], tiposMultimedia=[]}) {
    return (
        <div className="modal fade" id="modalCrearMedias" tabindex="-1" aria-labelledby="modalCrearMediasLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="modalCrearMediasLabel">Nueva Media</h1>
                    ...
                    <div className="modal-body">
                        <form>
                            ...
                            <select name="genero" onChange={handleChange} className="form-select">
                            ...
                            <select name="director" onChange={handleChange} className="form-select">
                            ...
                            <select name="productora" onChange={handleChange} className="form-select">
                            ...
                            <select name="tipoMultimedia" onChange={handleChange} className="form-select">
